...
export function RiskMatrixChart() {
  ...
  return (
    <Card
      title="Strategic intensity × likelihood matrix"
      description="Each bubble is a topic (size = average relevance). Quadrant lines are visual guides only — the dataset has no risk category field."
    >
        ...
        <div className="h-80">
          <ResponsiveContainer width="100%" height="100%">
            <ScatterChart margin={{ top: 12, right: 12, bottom: 8, left: 8 }}>
              ...
              />
              <ZAxis type="number" dataKey="relevance" range={[40, 240]} name="Relevance" />
